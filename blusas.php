            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="page-title text-center">
                        <h2 style="color:#444242;">BLUSAS</h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12 col-md-8 col-lg-9">
                    <div class="shop_grid_product_area">
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="single-product-wrapper">
                                ...
                                <div class="product-description" style="background-color: #EFD9AB;">
                                    ...
                                    <a href="#">
                                        <h6 style="color: #444242;">Blusa Nocturna Chic</h6>
                                    </a>
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="single-product-wrapper">
                                <div class="product-img">
                                    <img src="img/productos/blusas/b2.jpg" alt="">
                                ...
                                <div class="product-description" style="background-color: #EFD9AB;">
                                    ...
                                    <a href="single-product-details.html">
                                        <h6 style="color: #444242;">Rayas Urbanass</h6>
                                    </a>
                                    <p class="product-price" style="color: #444242;">$225.000</p>
                                    <div class="hover-content">
                                        <div class="add-to-cart-btn">
                                            <a href="#" class="btn essence-btn">Añadir Al Carrito</a>
                                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="single-product-wrapper">
                                <div class="product-img">
                                    <img src="img/productos/blusas/b3.jpg" alt="">
                                ...
                                <div class="product-description" style="background-color: #EFD9AB;">
                                    <span style="color: #444242;">topshop</span>
                                    <a href="#">
                                        <h6 style="color: #444242;">Trenzas de Nieve</h6>
                                    </a>
                                    <p class="product-price" style="color: #444242;">$185.000</p>
                                    <div class="hover-content">
                                        <div class="add-to-cart-btn">
                                            <a href="#" class="btn essence-btn">Añadir Al Carrito</a>
                                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="single-product-wrapper">
                                <div class="product-img">
                                    <img src="img/productos/blusas/b4.jpg" alt="">
                                ...
                                <div class="product-description" style="background-color: #EFD9AB;">
                                    <span style="color: #444242;">topshop</span>
                                    <a href="#">
                                        <h6 style="color: #444242;">Brisa Suave</h6>
                                    </a>
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="single-product-wrapper">
                                <div class="product-img">
                                    <img src="img/productos/blusas/b5.jpg" alt="">
                                ...
                                <div class="product-description" style="background-color: #EFD9AB;">
                                    <span style="color: #444242;">topshop</span>
                                    <a href="#">
                                        <h6 style="color: #444242;">Minimal Black</h6>
                                    </a>
                                    <p class="product-price" style="color: #444242;"> $235.000</p>
                                    <div class="hover-content">
                                        <div class="add-to-cart-btn">
                                            <a href="#" class="btn essence-btn">Añadir Al Carrito</a>
                                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="single-product-wrapper">
                                <div class="product-img">
                                    <img src="img/productos/blusas/b6.jpg" alt="">
                                ...
                                <div class="product-description" style="background-color: #EFD9AB;">
                                    <span style="color: #444242;">topshop</span>
                                    <a href="#">
                                        <h6 style="color: #444242;">Natural Mint</h6>
                                    </a>
                                    <p class="product-price" style="color: #444242;">$229.000</p>
                                    <div class="hover-content">
                                        <div class="add-to-cart-btn">
                                            <a href="#" class="btn essence-btn">Añadir Al Carrito</a>
                                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="single-product-wrapper">
                                <div class="product-img">
                                    <img src="img/productos/blusas/b7.jpg" alt="">
                                ...
                                <div class="product-description" style="background-color: #EFD9AB;">
                                    <span style="color: #444242;">topshop</span>
                                    <a href="#">
                                        <h6 style="color: #444242;">Encanto Tropical</h6>
                                    </a>
                                    <p class="product-price" style="color: #444242;">$249.900</p>
                                    <div class="hover-content">
                                        <div class="add-to-cart-btn">
                                            <a href="#" class="btn essence-btn">Añadir Al Carrito</a>
                                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="single-product-wrapper">
                                <div class="product-img">
                                    <img src="img/productos/blusas/b8.jpg" alt="">
                                ...
                                <div class="product-description" style="background-color: #EFD9AB;">
                                    <span style="color: #444242;">topshop</span>
                                    <a href="#">
                                        <h6 style="color: #444242;">Líneas Elegantes</h6>
                                    </a>
                                    <p class="product-price" style="color: #444242;">$239.500</p>
                                    <div class="hover-content">
                                        <div class="add-to-cart-btn">
                                            <a href="#" class="btn essence-btn">Añadir Al Carrito</a>
                                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="single-product-wrapper">
                                <div class="product-img">
                                    <img src="img/productos/blusas/b9.jpg" alt="">
                                ...
                                <div class="product-description" style="background-color: #EFD9AB;">
                                    <span style="color: #444242;">topshop</span>
                                    <a href="#">
                                        <h6 style="color: #444242;">Cielo Brillante</h6>
                                    </a>
                                    <p class="product-price" style="color: #444242;">$198.000</p>
                                    <div class="hover-content">
                                        <div class="add-to-cart-btn">
                                            <a href="#" class="btn essence-btn">Añadir Al Carrito</a>
                                        </div>
