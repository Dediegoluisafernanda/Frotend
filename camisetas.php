            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="page-title text-center">
                        <h2 style="color:#444242;">CAMISETAS</h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12 col-md-8 col-lg-9">
                    <div class="shop_grid_product_area">
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="single-product-wrapper">
                                <div class="product-img">
                                    <img src="img/productos/camisetas/c3.jpg" alt="">
                                ...
                                <div class="product-description" style="background-color: #EFD9AB;">
                                    <span style="color: #444242;">topshop</span>
                                    <a href="#">
                                        <h6 style="color: #444242;">Lavanda Chic</h6>
                                    </a>
                                    <p class="product-price" style="color: #444242;">$174.000</p>
                                    <div class="hover-content">
                                        <div class="add-to-cart-btn">
                                            <a href="#" class="btn essence-btn">Añadir Al Carrito</a>
                                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="single-product-wrapper">
                                <div class="product-img">
                                    <img src="img/productos/camisetas/c4.jpg" alt="">
                                ...
                                <div class="product-description" style="background-color: #EFD9AB;">
                                    <span style="color: #444242;">topshop</span>
                                    <a href="#">
                                        <h6 style="color: #444242;">Aves del Caribe</h6>
                                    </a>
                                    <p class="product-price" style="color: #444242;">$149.000</p>
                                    <div class="hover-content">
                                        <div class="add-to-cart-btn">
                                            <a href="#" class="btn essence-btn">Añadir Al Carrito</a>
                                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="single-product-wrapper">
                                <div class="product-img">
                                    <img src="img/productos/camisetas/c5.jpg" alt="">
                                ...
                                <div class="product-description" style="background-color: #EFD9AB;">
                                    <span style="color: #444242;">topshop</span>
                                    <a href="#">
                                        <h6 style="color: #444242;">Estilo New Yorker</h6>
                                    </a>
                                    <p class="product-price" style="color: #444242;"> $120.000</p>
                                    <div class="hover-content">
                                        <div class="add-to-cart-btn">
                                            <a href="#" class="btn essence-btn">Añadir Al Carrito</a>
                                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="single-product-wrapper">
                                <div class="product-img">
                                    <img src="img/productos/camisetas/c6.jpg" alt="">
>
                                    <div class="product-favourite">
                                        <a href="#" class="favme fa fa-heart"></a>
                                    </div>
                                ...
                                <div class="product-description" style="background-color: #EFD9AB;">
                                    <span style="color: #444242;">topshop</span>
                                    <a href="#">
                                        <h6 style="color: #444242;">Líneas de Verano</h6>
                                    </a>
                                    <p class="product-price" style="color: #444242;">$135.500</p>
                                    <div class="hover-content">
                                        <div class="add-to-cart-btn">
                                            <a href="#" class="btn essence-btn">Añadir Al Carrito</a>
                                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="single-product-wrapper">
                                <div class="product-img">
                                    <img src="img/productos/camisetas/c7.jpg" alt="">
                                ...
                                <div class="product-description" style="background-color: #EFD9AB;">
                                    <span style="color: #444242;">topshop</span>
                                    <a href="#">
                                        <h6 style="color: #444242;">Clásico Natural</h6>
                                    </a>
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="single-product-wrapper">
                                <div class="product-img">
                                    <img src="img/productos/camisetas/c8.jpg" alt="">
                                ...
                                <div class="product-description" style="background-color: #EFD9AB;">
                                    ...
                                    <a href="single-product-details.html">
                                        <h6 style="color: #444242;">Violeta Ejecutivo</h6>
                                    </a>
                                    <p class="product-price" style="color: #444242;">$248.000</p>
                                    <div class="hover-content">
                                        <div class="add-to-cart-btn">
                                            <a href="#" class="btn essence-btn">Añadir Al Carrito</a>
                                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="single-product-wrapper">
                                ...
                                <div class="product-description" style="background-color: #EFD9AB;">
                                    <span style="color: #444242;">topshop</span>
                                    <a href="">
                                        <h6 style="color: #444242;">Rayo Urbano</h6>
                                    </a>
                                    <p class="product-price" style="color: #444242;">$155.000</p>
                                    <div class="hover-content">
                                        <div class="add-to-cart-btn">
                                            <a href="#" class="btn essence-btn">Añadir Al Carrito</a>
                                        </div>
